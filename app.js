// global variables 
const bookNumber = document.getElementById("books-List");
const bookContainer = document.getElementById("container1");
...
document.getElementById("search-button").addEventListener('click', () => {
    ...
    // Error block
    if (inputFieldText === '') {
        error.innerText = 'This Search field can not be empty';
        return;
    }
    else {
        error.textContent = '';
